...
class BaseProcessor:
    ...
    def set_context(self, context):
        """
        Used to directly set the context, rather than using the grouping mechanism used by `set_paragraphs`
        method. Use cautiously.
    ...
    def prompt(self):
        """
        Returns the prompt to use for the given context.
        """
        raise NotImplementedError("Please implement prompt")

    def process_results(self, results):
        """
        Processes the responses generated by the LLM into a format consumable by the API.
        ### params
        - results: a JSON containing the results from the LLM.
        """
